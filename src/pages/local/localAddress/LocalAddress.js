...
const LocalAddress = () => {
    ...
    return(
        <Wrapper>
            ...
            <S.textHeader>혜연님,<br></br>만남을 위한 두번째 단계 입니다.</S.textHeader>
            <S.placeText>거주지를 입력해주세요.</S.placeText>
            <S.searchBox></S.searchBox>
            <S.ddot></S.ddot>
            <S.roadText>{isGet ? inputAddressValue : "도로명주소 검색하기"}</S.roadText>
            <S.searchButton><S.glassImg src={searchImage} onClick={()=>{
                setModalState(true);
            }}></S.glassImg></S.searchButton>
            <DaumPostcode
                    style={postCodeStyle}
