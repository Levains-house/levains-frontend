...
const Main = () => {
    ...
    return(
        <Wrapper>
            ...
            <S.headerButton><S.headerImg src={headerImage}></S.headerImg></S.headerButton>
            {isHome ? 
            <>
            ...
            <S.logoButton><S.logoImg src={logoImage}></S.logoImg></S.logoButton>
            <S.homeButton onClick={()=>{Toggle(true)}}><S.homeImg src={homeImage}></S.homeImg></S.homeButton>
            <S.homeText>홈</S.homeText>
            <S.levainButton onClick={()=>{Toggle(false)}}><S.levainImg src={levainImage}></S.levainImg></S.levainButton>
